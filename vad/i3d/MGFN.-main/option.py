...
def parse_args():
    ...
    parser.add_argument('--rgb-list', default='/home/intern/lijie/baseline_output/MGFN.-main/train-list.txt', help='list of rgb features ')
    parser.add_argument('--test-rgb-list', default='/home/intern/lijie/baseline_output/MGFN.-main/test-list.txt', help='list of test rgb features ')
    parser.add_argument('--gt', default='/home/intern/lijie/Pistachio_dataset/VAD/i3d-features/gt.npy', help='file of ground truth ')
    # parser.add_argument('--test-rgb-list', default='/home/intern/lijie/Wan2.2/benchmark_test_last_i3d/test.list', help='list of test rgb features ')
    # parser.add_argument('--gt', default='/home/intern/lijie/Wan2.2/benchmark_test_last_gt/combined_segment_gt.npy', help='file of ground truth ')
