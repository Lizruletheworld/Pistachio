...
if __name__ == "__main__":
    ...
    wind = Visualizer(env = 'Me_URDMU', port = "2022", use_incoming_socket = False)
        ...
        if step % 10 == 0 and step > 10:
            ...
            if test_info["auc"][-1] > best_auc:
                ...
                utils.save_best_record(test_info, 
                    os.path.join(config.output_path, "me_best_record_{}.txt".format(config.seed)))

                torch.save(net.state_dict(), os.path.join(args.model_path, \
                    "me_trans_{}.pkl".format(config.seed)))
