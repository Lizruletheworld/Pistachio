...
def parse_args():
    ...
    elif 'Pistachio' in args.json_path:
        if args.video_root is None:
            args.video_root = str(pistachio_video_test_root())
        if args.prompt_flag == 'prior_q':
            args.prompt_flag = 'pistachio_prior_q'
    else:
...
class VideoClipDataset(Dataset):
    ...
    def __getitem__(self, _):
        ...
        vid_path = resolve_pistachio_video_path(self.video_root, k)
