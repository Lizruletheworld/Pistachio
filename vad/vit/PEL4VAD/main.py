...
def main(cfg):
    ...
    elif cfg.dataset == 'pistachio':
        train_data = PistachioDataset(cfg, test_mode=False)
        test_data = PistachioDataset(cfg, test_mode=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='pistachio', help='anomaly video dataset')
