...
from utils.dataset import PistachioDataset
from utils.tools import get_prompt_text, get_batch_label
import pistachio_option
...
if __name__ == '__main__':
    ...
    normal_dataset = PistachioDataset(args.visual_length, args.train_list, False, label_map, True)
    normal_loader = DataLoader(normal_dataset, batch_size=args.batch_size, shuffle=True, drop_last=True)
    anomaly_dataset = PistachioDataset(args.visual_length, args.train_list, False, label_map, False)
    anomaly_loader = DataLoader(anomaly_dataset, batch_size=args.batch_size, shuffle=True, drop_last=True)

    test_dataset = PistachioDataset(args.visual_length, args.test_list, True, label_map)
