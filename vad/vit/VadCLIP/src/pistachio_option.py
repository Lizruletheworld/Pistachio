...
parser.add_argument('--model-path', default='/home/intern/lijie/baseline/VadCLIP/model/model_me.pth')
parser.add_argument('--use-checkpoint', default=False, type=bool)
parser.add_argument('--checkpoint-path', default='/home/intern/lijie/baseline/VadCLIP/model/checkpoint.pth')
parser.add_argument('--batch-size', default=256, type=int)
parser.add_argument('--train-list', default='list/pistachio_CLIP_rgb.csv')
parser.add_argument('--test-list', default='list/pistachio_CLIP_rgbtest.csv')
parser.add_argument('--gt-path', default='/home/intern/lijie/Pistachio_dataset/VAD/vit-features/gt_me.npy')
